...
export function SampleForm() {
  ...
  return (
    <div className="max-w-md mx-auto p-6 rounded-lg border border-gray-300">
      <h2 className="text-2xl font-bold mb-6">サンプルフォーム</h2>

      <Form onFormSubmit={handleSubmit} className="space-y-6">
        {/* Combobox Field */}
        <Field.Root name="country">
          <Combobox.Root items={countries}>
            <div className="relative">
              ...
              <Field.Description className="text-sm text-gray-500 mb-2">
                現在お住まいの国を選択してください
              </Field.Description>
            </div>
            <Combobox.Portal>
